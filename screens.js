...
async function showDifficultySelection() {
    ...
    appContent.innerHTML = `            
        ...
        <div style="display:grid; grid-template-columns:repeat(auto-fit,minmax(220px,220px)); justify-content:center; gap:20px; margin:30px 0;">
...
function showPracticeMode() {
    ...
    <div class="game-card" style="text-align:center;">
        ...
        <div style="display:grid; grid-template-columns:repeat(auto-fit,minmax(200px,200px)); justify-content:center; gap:20px; margin:30px 0;">
